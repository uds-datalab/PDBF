...
{ \centering %
\lineChart{0.4\textwidth}{0.3\textwidth}{SELECT * FROM data1;}{Money (in €)}{Date}{false}{"title": "Title", "titleHeight": 25} %
\\ }
\vspace{-5pt}
\caption{Graph1}
\vspace{-20pt}
...
\noindent \begin{wrapfigure}{r!}{0.37\textwidth}
     \vspace{-12pt}
     { \centering %
     \lineChart{0.3\textwidth}{0.4\textwidth}{SELECT * FROM data1 WHERE date >= '2008/05/11';}{Money (in €)}{Date}{true}{}%
     \\ }
     \vspace{-5pt}
     \caption{Graph2}
     \vspace{-20pt}
...
\begin{figure}[h]
    \centering
    \lineChart{0.4\textwidth}{0.4\textwidth}{SELECT date, runtimeA AS engine_A, runtimeB AS engine_B FROM data2;}{Runtime (in seconds)}{Date}{false}{} \\
    \caption{Graph3}
\end{figure}
\begin{figure}[h]
    \centering
    \lineChart{0.4\textwidth}{0.4\textwidth}{SELECT Zahl1, Zahl2 as some_number FROM pgtest WHERE Zahl1 > 45000;}{Number}{Row ID}{false}{} \\
    \caption{Graph4}
\end{figure}
