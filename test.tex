...
\begin{figure}[h]
    \centering
    \lineChart[width=0.4\textwidth, height=0.4\textwidth, xunit=Date, yunit={Runtime [in sec]}]{SELECT date, runtimeA AS engine_A, runtimeB AS engine_B FROM data2;}\\%
    \caption{Graph3}
\end{figure}
\begin{figure}[h]
    \centering
    \lineChart[width=1.0\textwidth, height=0.5\textwidth, xunit=Row ID, yunit=Number]{SELECT Zahl1, Zahl2 as some_number FROM pgtest;}\\%
    \caption{Graph4}
\end{figure}
