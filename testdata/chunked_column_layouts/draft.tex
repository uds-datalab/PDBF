...
\begin{table}[!b] 
\pivotTable[width=0.478\textwidth, height=0.7478\textwidth, scale=0.666, rows={"Machine", "Table schema", "Query"}, aggregation=Minimum, aggregationattribute=Query time, aggregationBig=Minimum, aggregationattributeBig=Query time (in Sec)]
{SELECT
