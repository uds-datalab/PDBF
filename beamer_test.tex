...
\begin{frame}\frametitle{Line Chart with little data}
	{ \centering 
	\lineChart[width=0.8\textwidth, height=0.6\textwidth, xunit=Money (in €), yunit=Date, options={"title": "Title", "titleHeight": 20}]{SELECT * FROM data1;}%
	\\}
\end{frame}
\mdqon
\note{bla}
...
\begin{frame}
\vspace{1.0cm}
	\begin{center}\sql{SELECT * FROM test;}\\Thank you for your attention!\end{center}
\end{frame}
\note{bla}
