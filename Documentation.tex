...
TODO: write about special sql functions. link to alasql.\\
...
Note: The first column of the query result is used for the x-Axis, all other columns are used for y-Axis.\\[8pt] 
\noindent Options:\\[3pt]
%
Common options\\[4pt]
%
