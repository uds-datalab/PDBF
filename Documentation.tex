...
<<<<<<< HEAD
Mostly sql syntax is standart sql, but for example attributes with spaces in their name have to be sourrounded by square brackets. E.g. SELECT attribute AS [attribute with spaces] FROM test;\\
=======
...
>>>>>>> 08537fe12379ad2e8665543faa693435f4eefb65
