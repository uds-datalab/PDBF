...
\author{
 Patrick Bender \hspace{2cm} Lukas Lange \hspace{2cm} Shoaib Malik\\
...
\textbf{Note:} Relative filepaths are relative to the tex file.\\
\textbf{Note:} The \verb|\dbSQLFile{fileWithSQLQueries}|-command will search the whole directory (it will not scan deeper file structures), and chooses the filename according to existing filename. \\
