...
\textbf{WARNING:} \verb|\dbSQLText| and \verb|\dbSQLFile| are currently horribly slow, even for medium sized (more than 100 tuples) amounts of data. Use \verb|\dbSQLJDBC| instead.
