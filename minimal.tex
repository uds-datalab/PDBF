...
\dbSQLText{CREATE TABLE test(a int, b int, c int); INSERT INTO test VALUES(1, 1, 1); INSERT INTO test VALUES(2, 2, 4); INSERT INTO test VALUES(3, 3, 8); INSERT INTO test VALUES(4, 4, 16);}
...
\chart[width=0.45\textwidth, height=0.3\textwidth, logscale=true, chartType=line, name=testname]{SELECT * FROM test;}
\chart[width=0.45\textwidth, height=0.3\textwidth, chartType=bar]{SELECT * FROM test;}\\[3pt]
{\fontfamily{phv} \tiny \selectfont
\noindent
Change the font before this line to Helvetica and fontsize to tiny.\\[3pt]
\chart[width=0.6\textwidth, height=0.25\textwidth, chartType=signatureplot]{SELECT b FROM test;}\\[3pt]
