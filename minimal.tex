...
\graph[width=0.75\textwidth, height=0.5\textwidth]{examples/graphs/graph2.txt} \\
\graph[width=0.75\textwidth, height=0.75\textwidth, customImage=examples/graphs/customGraph.png]{} \\
