 ...
 */
Graph.Renderer.Raphael = function(element, graph, width, height, canvasId, draggable) {
...
Graph.Renderer.Raphael.prototype = {
    ...
    draw: function(canvasId) {
        ...
        for (i in this.graph.nodes) {
            this.drawNode(this.graph.nodes[i], canvasId);
        }
    ...
    drawNode: function(node, canvasId) {
        ...
        if(!node.render) {
            node.render = function(r, node) {
                ...
                /* set DOM node ID */
                ellipse.node.id = canvasId+"_"+node.id;
                shape = r.set().
                    push(ellipse).
