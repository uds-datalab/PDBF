  ...
  callWithJQuery(function($) {
        ...
        return function(_arg) {
          ...
          return function(data, rowKey, colKey) {
            return {
              ...
              format: function(x){return formatter(x[attr]);},
              numInputs: attr != null ? 0 : 1
            };
          };
        };
    ...
    pivotTableRenderer = function(pivotData, opts) {
      ...
      if (rowAttrs.length !== 0) {
		...
		if (aggr.special && pivotData.unused != undefined && colAttrs.length === 0) {
      ...
      for (i in rowKeys) {
		...
		if (totalAggregator.special && pivotData.unused != undefined) {
