...
public class MinifyResources {
	...
	String command[] = {"java", "-jar", "lib/compiler.jar", "out/web/base64.js", "out/web/compatibility.js", "out/web/dygraphs.js", "out/web/alasql.js", 
		"out/web/excanvas.compiled.js", "out/web/diff_match_patch.js", "out/web/codemirror-compressed.js",
	...
	try {
	    ...
	    String out = pdfJS + pdfworkerJS + "</script><style>" + viewerCSS + pivotCSS + codemirrorCSS + "</style>";
