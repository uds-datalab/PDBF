...
public class MinifyResources {
	...
	String command[] = {"java", "-jar", "lib/compiler.jar", "out/web/base64.js", "out/web/d3.js", "out/web/c3.js", 
	...
	try {
	    ...
	    String out = pdfJS + pdfworkerJS + codemirrorJS + datatablesJS + alasqlJS + "</script><style>" + viewerCSS + pivotCSS + codemirrorCSS + datatablesCSS + c3CSS + "</style>";
